function [u]=utvidgningdel1(n) %utvidgning 2.1 L=skiktets tjocklek 
format long
L=2.3
Ta=350;
Tb=20;
...
r=r1+h;
b=zeros(n+1,1);
b(1)=-Ta*(r/h^2 - 1/(2*h) - (r.*kprim(r)/(k(r)*2*h))); %första värdet i b.
...
ylabel('temperatur');
xlabel('radie');
legend({'= temperaturkurva',' = slut temperatur (159.88C)'},'Fontsize',14)
